...
public class No_1744_CanYouEatYourFavoriteCandyOnYourFavoriteDay {
    public static void main(String[] args) {
        Solution solution = new No_1744_CanYouEatYourFavoriteCandyOnYourFavoriteDay().new Solution();
        solution.canEat(new int[]{7, 4, 5, 3, 8}, new int[][]{{0, 2, 2}, {4, 2, 4}, {2, 13, 1000000000}});
    }
