...
public class No_1713_MinimumOperationsToMakeASubsequence{
    public static void main(String[] args) {
       Solution solution = new No_1713_MinimumOperationsToMakeASubsequence().new Solution();
       solution.minOperations(new int[]{17,18,14,13,6,9,1,3,2,20}, new int[]{18,15,14,6,6,13,15,20,2,6});
    }
//leetcode submit region begin(Prohibit modification and deletion)
class Solution {
    /**
     * 初见思路：先找出target和arr中公有的最长子序列，然后用target长度减去子序列长度，就是操作的步数
     * @param target
     * @param arr
     * @return
     */
